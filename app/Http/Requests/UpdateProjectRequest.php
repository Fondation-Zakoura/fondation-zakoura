...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'project_nature' => ['required', Rule::in(['Opérationnel', 'Institutionnel', 'Expérimental'])],
            ...
            // 'partners.*.id' => 'required_with:partners|exists:partners,id',
            // 'partners.*.role' => 'required_with:partners|string|max:255',
            // 'partners.*.quote_part' => 'required_with:partners|numeric|min:0|max:100',
        ];
    }
