...
class ProjectService
{
     ...
     */
    public function __construct(ProjectRepository $projectRepository, UserRepository $userRepository, BankAccountRepository $bankAccountRepository)
    {
    ...
    public function getProjects()
    {
        ...
        return $query->with(['responsible', 'createdBy', 'bankAccount','projectType','projectStatus'])->paginate(10); 
    }
